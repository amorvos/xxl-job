        ...
        while (!toStop) {
            ...
            try {
                ...
                if (triggerParam != null) {
                    ...
                    // handle job
                    ApiResult<String> executeResult = null;
                    try {
                        ...
                        XxlJobLogger.log("<br>----------- xxl-job job execute start -----------<br>----------- Params:"
                                + Arrays.toString(handlerParams));

                        executeResult = handler.execute(handlerParams);
                        if (executeResult == null) {
                            executeResult = ApiResult.FAIL;
                        }
                        ...
                        executeResult = new ApiResult<String>(ApiResult.FAIL_CODE, errorMsg);
