...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public Map<String, Object> dashboardInfo() {
        ...
        int jobLogSuccessCount = xxlJobLogDao.triggerCountByHandleCode(ApiResult.SUCCESS_CODE);
    ...
    public ApiResult<Map<String, Object>> triggerChartDate() {
        ...
        List<Map<String, Object>> triggerCountMapSuc = xxlJobLogDao.triggerCountByDay(from, to, ApiResult.SUCCESS_CODE);
