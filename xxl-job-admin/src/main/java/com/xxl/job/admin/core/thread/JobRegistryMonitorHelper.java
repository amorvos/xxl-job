                ...
                while (!toStop) {
                    try {
                        ...
                        if (CollectionUtils.isNotEmpty(groupList)) {
                            ...
                            XxlJobDynamicScheduler.xxlJobRegistryDao.removeDead(RegistryConstants.DEAD_TIMEOUT);

                            // fresh online address (admin/executor)
                            HashMap<String, List<String>> appAddressMap = new HashMap<String, List<String>>();
                            List<XxlJobRegistry> list = XxlJobDynamicScheduler.xxlJobRegistryDao
                                    .findAll(RegistryConstants.DEAD_TIMEOUT);
                            if (list != null) {
